...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Inter:wght@400;700&family=Lexend+Deca&family=Poppins:wght@400;500;700&display=swap"
        rel="stylesheet">
    ...
    <!-- logo title bar -->
    <link rel="icon" href="asset/img/logo small perpetakan.png" type="image/x-icon">
                ...
                <div class="row">
                    <div class="col-4 mb-4">
                        <div class="card p-2" style="width: 22rem;">
                            <img src="asset/img/ruko1.png" alt="">
                            <div class="card-body">
                                <h4>IDR 600.000.000</h4>
                                <p class="mb-4 lh-sm">Jember,Jawa Timur <br> <span class="text-danger">Bangunan</span></p>
                            </div>
                            <div class="card-fasilitas d-flex justify-content-between px-4">
                                <span>
                                    <img src="asset/img/mdi_bed.png" alt=""> 3
                                    <p>Kamar tidur</p>
                                </span>
                                <span>
                                    <img src="asset/img/fa-solid_bath.png" alt=""> 3
                                    <p>Kamar Mandi</p>
                                </span>
                                <span>
                                    <img src="asset/img/luas.png" alt=""> 3
                                    <p>Luas</p>
                                </span>
                            </div>
                        </div>
